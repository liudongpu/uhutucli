...
@SuppressLint("NewApi") public class BluetoothChatService {
    // Debugging
    private static final String TAG = "log.device.CS";
     ...
     */
    public BluetoothChatService(Context context, CallBack c,byte[] command) {
...
//        		byte[] _commd_Handshake = DeviceCommand.commandConfirmEquipment();
   				tmpOut.write(byteCommand);
            } catch (IOException e) {
